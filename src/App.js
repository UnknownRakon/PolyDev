  ...
  const modal = (
    <ModalRoot activeModal={activeModal}>
      ...
      >
        <Div>
          <Text>
            Очная - занятия проводятся по будням, и на некоторых направлениях по
            субботам. Если не посещать пары можно получить недопуск или даже
            отчислится.
            <br />
            <br />
            Заочная - вы встречаетесь с преподавателями вживую только два раза в
            году - на сессии. Объем программы такой же как и на очной, но
            большую часть студент изучает самостоятельно.
          </Text>
        </Div>
      </ModalCard>
      <ModalCard
      ...
      >
        <Div>
          <Text>
            Бакалавриат - базовый уровень высшего образования. Поступать на
            бакалавриат имеют право выпускники 11 класса, сдавшие егэ или
            выпускники колледжей по конкурсу внутренних экзаменов ВУЗа. Обучение
            длится 4 года.
            <br />
            <br />
            Специалитет - тоже высшее образование, но выпускники получают
            конкретную профессию и возможность преподавать. Обучение длится 5
            лет.
            <br />
            <br />
            Магистратура - второй этап высшего образования. Для поступления
            необходимо иметь диплом бакалавра или специалитета. Обучение длится
            2 года
          </Text>
        </Div>
      </ModalCard>
