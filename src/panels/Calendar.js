            ...
            try {
              let data = await callAPIMethod(
                ...
                "allow",
                {
                  ...
                  v: "5.131",
                  access_token:
                    "c437153fc437153fc437153f0bc4403b1ecc437c437153fa4511fafc89134934d49c427",
                }
              );
      ...
      <Group>
        <Div style={{ display: "flex" }}>
          <Button
            ...
            mode="primary"
            onClick={() =>
              addNotifies(date, document.getElementById("input").value)
            }
          >
            ...
            <Header
              ...
              aside={
                texts.length ? (
                  <Icon16Clear
                    mode="destructive"
                    onClick={() => deleteNotifiy(choosedDate)}
                  />
                ) : (
                  ""
                )
            ...
            {texts.length ? (
              texts.map((text) => (
                <Header
                  ...
                  aside={
                    <Icon16Clear
                      onClick={() => deleteNotifiy1(choosedDate, text)}
                    />
                  }
                >
                  {text}
