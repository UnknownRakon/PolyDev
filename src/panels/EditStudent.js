    ...
    validateForm = () => {
        this.setState({
            changed:
                ...
                this.state.profValid &&
                this.state.studValid &&
                this.state.year !== '' &&
                this.state.specialty !== '' &&
                this.state.dorm !== '' &&
                ((this.state.dormnum !== '' && this.state.dorm == 'Yes') ||
                    this.state.dorm == 'No'),
        });
    };
    toStorage = (event) => {
            ...
            <Panel id={this.props.id}>
                ...
                <FormItem top="Направление">
                    <Select
                        ...
                        options={[
                            {
                                value: 'Информационная безопасность автоматизированных систем',
                                label: 'Информационная безопасность автоматизированных систем',
                            },
                            {
                                value: 'Прикладная математика и информатика (Большие и открытые данные)',
                                label: 'Прикладная математика и информатика (Большие и открытые данные)',
                            },
                            {
                                value: 'Веб-технологии',
                                label: 'Веб-технологии',
                            },
                            {
                                value: 'Интеграция и программирование в САПР',
                                label: 'Интеграция и программирование в САПР',
                            },
                            {
                                value: 'Программное обеспечение информационных систем',
                                label: 'Программное обеспечение информационных систем',
                            },
                            {
                                value: 'Киберфизические системы',
                                label: 'Киберфизические системы',
                            },
                            {
                                value: 'Большие и открытые данные',
                                label: 'Большие и открытые данные',
                            },
                            {
                                value: 'Корпоративные информационные системы',
                                label: 'Корпоративные информационные системы',
                            },
                            {
                ...
                <FormItem top="Группа">
                    <Input
                        ...
                        name="group"
                        className={
                            !this.state.groupValid && this.state.group != ''
                                ? 'red'
                                : null
                        }
                        autocomplete="off"
                ...
                <FormItem top="Номер студенческого(необязательно)">
                    <Input
                        ...
                        name="stud"
                        inputMode={'numeric'}
                        className={!this.state.studValid ? 'red' : null}
                        autocomplete="off"
                ...
                >
                    <Input
                        ...
                        inputMode={'numeric'}
                        name="prof"
                        className={!this.state.profValid ? 'red' : null}
                        autocomplete="off"
