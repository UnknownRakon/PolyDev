        ...
        <Group header={<Header mode="primary">Привет!</Header>}>
          <Div className="homepage-subhead">
            <Subhead weight="semibold">
              Это приложение для абитуриентов и студентов факультета
              информационных технологий Московского политеха.
            </Subhead>
          </Div>
          <Cell
            before={
              ...
              <Header
                ...
                aside={
                  <Icon20QuestionOutline
                    onClick={() => setActiveModal(MODAL_CARD_ONE)}
                  />
                }
            ...
            {wantStudyForm == "Очная" ? (
              <FormLayout>
                <Header
                  ...
                  aside={
                    <Icon20QuestionOutline
                      onClick={() => setActiveModal(MODAL_CARD_TWO)}
                    />
                  }
                >
                  Ступень образования
        ...
        <FixedLayout filled vertical="bottom">
          <Div>
            <Button
              ...
              data-to={want ? "pick-directions" : "student-form-filling"}
            >
              Далее
            </Button>
          </Div>
