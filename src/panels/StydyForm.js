      ...
      <Group>
        <Div>
          <Caption className="captionCaps" level="1" weight="semibold" caps>
            Круто! Мы рады, что тебе интересен наш университет. Расскажи, какая
            форма обучения тебе нравится?
          </Caption>
          <FormLayout>
            <FormItem top="Форма обуение">
              <Radio name="radio" value="intramural" defaultChecked>
                Очная
              </Radio>
              <Radio name="radio" value="extramural">
                Заочная
              </Radio>
            </FormItem>
          </FormLayout>
